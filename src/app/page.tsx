  ...
  return (
    <section className="space-y-2">
      ...
      <p className="text-pretty">
        I’m, a Front-End Developer, UI/UX Designer who loves bringing ideas to
        life—whether it’s through clean, responsive code or designing user
        experiences that just feel right. I’m big on details and always looking
        for that perfect balance between functionality and good design.
        <br />
        <br />
        ...
        <br />
        <br />
        So, whether we’re talking websites, apps I’m always up for the next
        challenge.
      </p>
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 xs:gap-8 sm:gap-2 w-full !t-8!">
